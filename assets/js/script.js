...
//--3 Imprimir consultas médicas en el HTML
...
let lista_pacientes = radiologia.concat(traumatologia, dental);
...
for(let i = 0; i < lista_pacientes.length; i++){
    ...
    <tr>
        <td>${lista_pacientes[i].paciente}</td>
    </tr>
    `
};

document.getElementById('pacientes-tabla').innerHTML = lista;

// --5 Pacientes con ISAPRE en Dental
let isapre = dental.filter(function(cliente){
...
for(let i = 0; i < isapre.length; i++){
    ...
    <tr>
        <td>${isapre[i].paciente}</td>
        <td>${isapre[i].prevision}</td>
    </tr>
    `
};

document.getElementById('isapre-tabla').innerHTML = lista_isapre;


//--6 Pacientes con FONASA en Traumatología

let fonasa = traumatologia.filter(function(cliente){
...
for(let i = 0; i < fonasa.length; i++){
    ...
    <tr>
        <td>${fonasa[i].paciente}</td>
        <td>${fonasa[i].prevision}</td>
    </tr>
    `
};

document.getElementById('fonasa-tabla').innerHTML = lista_fonasa;
